#!/usr/bin/env python3
"""
最小加载/执行测试：1层、1帧、7 arms。用于确认 UIH 能加载并执行基本 RF/gradient/ADC。
...
TEST_ID = "T01_1slice_1frame_minimal"
PURPOSE = "最小加载/执行测试：1层、1帧、7 arms。用于确认 UIH 能加载并执行基本 RF/gradient/ADC。"
NUM_SLICES = 1
SLICE_SHIFT_MM = 2.0
ARMS_PER_FRAME = 7
FRAMES_PER_SLICE = 1
