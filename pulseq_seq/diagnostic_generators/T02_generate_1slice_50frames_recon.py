#!/usr/bin/env python3
"""
单层完整 real-time cine/reconstruction smoke test：1层、50帧、350 arms。用于 raw、trajectory 和重建。
...
TEST_ID = "T02_1slice_50frames_recon"
PURPOSE = "单层完整 real-time cine/reconstruction smoke test：1层、50帧、350 arms。用于 raw、trajectory 和重建。"
NUM_SLICES = 1
SLICE_SHIFT_MM = 2.0
ARMS_PER_FRAME = 7
FRAMES_PER_SLICE = 50
