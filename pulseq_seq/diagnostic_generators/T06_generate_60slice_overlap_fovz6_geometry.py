#!/usr/bin/env python3
"""
复现当前60层规划但每层仅1帧；FOV-z仍为6 mm。用于复现 linear-gradient-area warning。
...
TEST_ID = "T06_60slice_overlap_fovz6_geometry"
PURPOSE = "复现当前60层规划但每层仅1帧；FOV-z仍为6 mm。用于复现 linear-gradient-area warning。"
NUM_SLICES = 60
SLICE_SHIFT_MM = 2.0
ARMS_PER_FRAME = 7
FRAMES_PER_SLICE = 1
