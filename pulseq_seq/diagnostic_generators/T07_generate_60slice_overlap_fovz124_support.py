#!/usr/bin/env python3
"""
60层几何 A/B 测试：层中心仍为 -59..+59 mm，但 FOV-z=真实 support 124 mm。
...
TEST_ID = "T07_60slice_overlap_fovz124_support"
PURPOSE = "60层几何 A/B 测试：层中心仍为 -59..+59 mm，但 FOV-z=真实 support 124 mm。"
NUM_SLICES = 60
SLICE_SHIFT_MM = 2.0
ARMS_PER_FRAME = 7
FRAMES_PER_SLICE = 1
