#!/usr/bin/env python3
"""
3层重叠层几何 + 短时间序列测试：3 slices、2 mm shift、5 frames/slice、7 arms/frame、FOV-z=6 mm。
...
TEST_ID = "T08_3slice_overlap_fovz6_5frames"
PURPOSE = "3层重叠层几何 + 短时间序列测试：3 slices、2 mm shift、5 frames/slice、7 arms/frame、FOV-z=6 mm。"
