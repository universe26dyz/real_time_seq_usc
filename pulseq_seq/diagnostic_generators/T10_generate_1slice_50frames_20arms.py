#!/usr/bin/env python3
"""
T02 的高 arms/frame 版本：1 slice、50 frames/slice、20 arms/frame、FOV-z=6 mm。用于比较更低欠采样下的重建稳定性。
...
TEST_ID = "T10_1slice_50frames_20arms"
PURPOSE = "T02 的高 arms/frame 版本：1 slice、50 frames/slice、20 arms/frame、FOV-z=6 mm。用于比较更低欠采样下的重建稳定性。"
